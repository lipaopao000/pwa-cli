...
class GithubComTencentWeKnoraInternalTypesFAQBatchUpsertPayload(BaseModel):
    """
    GithubComTencentWeKnoraInternalTypesFAQBatchUpsertPayload
    """ # noqa: E501
    entries: List[GithubComTencentWeKnoraInternalTypesFAQEntryPayload]
    knowledge_id: Optional[StrictStr] = None
    mode: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["entries", "knowledge_id", "mode"]
    ...
    def mode_validate_enum(cls, value):
        ...
        if value not in set(['append', 'replace']):
            raise ValueError("must be one of enum values ('append', 'replace')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [GithubComTencentWeKnoraInternalTypesFAQEntryPayload.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
