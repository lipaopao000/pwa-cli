...
class InternalHandlerTextRelationExtractionRequest(BaseModel):
    """
    InternalHandlerTextRelationExtractionRequest
    """ # noqa: E501
    llm_config: Optional[InternalHandlerLLMConfig] = None
    tags: List[StrictStr]
    text: StrictStr
    __properties: ClassVar[List[str]] = ["llm_config", "tags", "text"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "llm_config": InternalHandlerLLMConfig.from_dict(obj["llm_config"]) if obj.get("llm_config") is not None else None,
            "tags": obj.get("tags"),
            "text": obj.get("text")
        })
        return _obj
