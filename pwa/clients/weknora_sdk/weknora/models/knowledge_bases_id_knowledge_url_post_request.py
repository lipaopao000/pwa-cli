...
class KnowledgeBasesIdKnowledgeUrlPostRequest(BaseModel):
    """
    KnowledgeBasesIdKnowledgeUrlPostRequest
    """ # noqa: E501
    enable_multimodel: Optional[StrictBool] = None
    title: Optional[StrictStr] = None
    url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["enable_multimodel", "title", "url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "enable_multimodel": obj.get("enable_multimodel"),
            "title": obj.get("title"),
            "url": obj.get("url")
        })
        return _obj
