...
class InteractiveMenu:
    ...
    def __init__(
        self, title: str, options: List[MenuOption], show_back: bool = False, show_quit: bool = True
    ):
        """
                        ...
                        def _(event):
                            ...
                            for i, choice in enumerate(prompt.content_control.choices):
                                ...
                                choice_value = (
                                    ...
                                    else getattr(choice, "value", None)
                                )
...
def create_simple_menu(
    title: str, options: List[Tuple[str, str]], show_back: bool = False, show_quit: bool = True
) -> InteractiveMenu:
    """
    ...
    """
    menu_options = [MenuOption(key=key, label=label) for key, label in options]

    return InteractiveMenu(
        title=title, options=menu_options, show_back=show_back, show_quit=show_quit
    )
